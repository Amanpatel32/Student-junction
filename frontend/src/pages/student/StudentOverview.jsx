  ...
  if (courses.length === 0) {
    return (
      <EmptyState
        ...
        description="Ask your institute administrator to enroll you in a course."
      />
    );
  }
  ...
  return (
    <>
      <div className="mb-6">
        ...
        <p className="text-sm text-campus-inkSoft">You are enrolled in {courses.length} course{courses.length === 1 ? '' : 's'}</p>
      </div>
        ...
        {courses.map((c, i) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              {c.schedule && (
                <p className="mt-3 text-xs italic text-campus-inkSoft border-t border-campus-line pt-3">
                  📅 {c.schedule}
                </p>
              )}
            </div>
